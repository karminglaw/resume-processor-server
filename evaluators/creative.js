  ...
  function generatePrompt(applications) {
    ...
    return {
      ...
      messages: [
        {
          role: "system",
          content: "You are a precise creative professional resume evaluator. Only mention skills and experience that are explicitly stated in the resume. Do not assume or infer skills that aren't directly mentioned."
        },
        {
          role: "user",
